...
public class CodeMsg {
    ...
    public static CodeMsg ICON_ALREADY_EXIST = new CodeMsg(500118  , "该图标已存在");
    ...
    public static CodeMsg ROLE_ALREADY_EXIST = new CodeMsg(500309, "该角色已存在");
    ...
    // 项目模块5005XX
    public static CodeMsg USER_HAVE_NOT_PROJECT = new CodeMsg(500500, "您还没有项目");
    public static CodeMsg GROUP_HAVE_NOT_PROJECT = new CodeMsg(500501, "本组还没有项目");
